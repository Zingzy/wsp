...
describe("windowOptions", () => {
  it("on macOS hides the title bar, puts the lights in the header row, frosts the window behind a transparent page and names the page's class", () => {
    ...
    expect(options).toMatchObject({
      ...
      webPreferences: { nodeIntegration: false, contextIsolation: true, sandbox: true, preload: "/app/preload.cjs", additionalArguments: ["--wsp-version=0.1.5", "--wsp-html-class=desktop-mac"] },
    });
