...
- **The desktop app**: the two buttons on [the site](https://wspx.vercel.app/), which link the newest release directly. One macOS disk image carries both Apple silicon and Intel; Linux is an AppImage. Both also sit on the [releases page](https://github.com/Zingzy/wsp/releases). The bundles are unsigned; the release notes say how to open them.
