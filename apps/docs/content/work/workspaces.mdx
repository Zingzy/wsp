...
`rename` names the workspace on this computer, the name every listing shows and the one every verb takes. A name another workspace holds, or a blank one, is refused. Threads on the machine run on through it.
