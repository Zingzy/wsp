...
| | Claude Code | Codex |
| --- | --- | --- |
| models | `claude-opus-5-5` (default), `claude-fable-5-1`, `claude-sonnet-5`, `claude-haiku-4-5-20251001` | `gpt-5.6-sol` (default), `gpt-5.6-terra`, `gpt-5.6-luna`, `gpt-5.5`, `gpt-5.2` |
| efforts | `low`, `medium`, `high` (default), `xhigh`, `max`; none on `claude-haiku-4-5-20251001` | `low` (default), `medium`, `high`, `xhigh`, `max`, `ultra` |
