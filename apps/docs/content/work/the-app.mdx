...
<Callout type="info">
  There is no in-app theme toggle; the app ships dark. There is no auto-updater; Settings > About names a newer release when there is one, and a new version is a new bundle from the releases page.
</Callout>
