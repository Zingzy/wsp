...
// and the update line. The update resolves after a moment; the hello that
// names the current version lands later, as it does when the link redials.
...
import { provideDaemonHello } from "../../src/files/wire";
...
const api: Api = {
  ...
  updateDaemon: async () => {
    ...
    setTimeout(() => {
      ...
      provideDaemonHello(workspace.id, { root: "/root", version: DAEMON_VERSION });
      const GiB = 1024 ** 3;
...
provideDaemonHello(workspace.id, { root: "/root", version: 1 });
