...
if (renderSkipped !== undefined) console.info(`import layout render test skipped: ${renderSkipped}`);
...
describe.skipIf(renderSkipped !== undefined)("the import dialog laid out in Chromium", () => {
