...
import { CODE_EXPIRED_LINE, CODE_GOOD_LINE, DEFAULT_PREFERENCES, PLACES_WORDS, doorPortHeldLine, placeAddSheetWord, type EventUnion, type PlaceDoorView, type PlaceView, type WorkspaceStatus, type WorkspaceView } from "@wsp/protocol";
...
beforeEach(() => {
  useStore.setState({ api: null, places: [], workspaces: [], statuses: {}, sessions: {}, addComputerOpen: false, settingsOpen: false, preferences: { ...DEFAULT_PREFERENCES, labs: false } });
});
