...
import { CODE_EXPIRED_LINE, CODE_GOOD_LINE, DEFAULT_PREFERENCES, PLACE_INSTALL, PLACES_WORDS, absentRoad, doorPortHeldLine, placeAddSheetWord, type EventUnion, type PlaceDoorView, type PlaceView, type WorkspaceView } from "@wsp/protocol";
