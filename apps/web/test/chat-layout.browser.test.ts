...
if (skipped !== undefined) console.info(`chat layout render test skipped: ${skipped}`);

describe.skipIf(skipped !== undefined)("the chat's message body laid out in Chromium", () => {
