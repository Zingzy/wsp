...
describe("deriveSidebarProjects", () => {
  ...
  it("live run 1: two machines, the one created later and still quiet above the one whose thread ended before it existed, each a remote project with its machine as the environment label", () => {
    ...
    expect(projects[1]?.threads).toEqual([
      { id: "s1", threadId: null, sessionId: "s1", workspaceId: LIVE_WS, title: "hello", status: "completed", ran: true, startedAt: "2026-09-02T17:19:35.668Z", endedAt: "2026-09-02T17:19:37.768Z", indicator: { label: "Idle", tone: "neutral", pulse: false }, harness: "claude", startedBy: "person", project: null, parentThreadId: null, costUsd: null },
      { id: "s0", threadId: null, sessionId: "s0", workspaceId: LIVE_WS, title: "59094224", status: "running", ran: true, startedAt: null, endedAt: null, indicator: { label: "Working", tone: "neutral", pulse: true }, harness: "claude", startedBy: "person", project: null, parentThreadId: null, costUsd: null },
    ]);
  });
