...
if (renderSkipped !== undefined) console.info(`usage chart render test skipped: ${renderSkipped}`);

describe.skipIf(renderSkipped !== undefined)("the usage chart laid out in Chromium", () => {
