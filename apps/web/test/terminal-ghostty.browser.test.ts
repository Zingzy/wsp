...
describe.skipIf(skipped !== undefined)("a translucent Ghostty theme on the surface in Chromium", () => {
  ...
  it.each(["dark", "light"] as const)("%s: the padding holds the theme background at the file's alpha, slot one colors the red word, the cursor is an underline", async scheme => {
