...
import { goneRefusal, machineWord, NO_REBUILD_NEEDED, ownDaemonDown, threadForgetRefusal, undrivenRefusal, type HarnessCatalog, type PlaceView, type SessionStatus, type WorkspaceState, type WorkspaceStatus, type WorkspaceView } from "@wsp/protocol";
...
describe("workspace actions", () => {
  ...
  it("refuses a preview and a forget on this computer in the one sentence, never by calling it unreachable", () => {
    ...
    expect(actionById(fork, "forget").refusal).toBe("Only a workspace whose computer is gone can be forgotten; this one is unreachable");
  });
