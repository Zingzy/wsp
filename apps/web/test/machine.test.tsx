...
import { DEFAULT_PREFERENCES, DAEMON_VERSION, FREE_WORD, LINEAGE_MARKS, IMAGE_ALREADY_NEWEST, IMAGE_MOVE_CONFIRM, NO_LINGER_LINE, NOT_ON_THIS_KIND, fmtBytes, fmtSize, imageKeptLine, kindWords, machineLacksShort, servesReading, workspaceKind } from "@wsp/protocol";
import type {
  Capabilities,
  EventUnion,
  GoldenMissingTool,
