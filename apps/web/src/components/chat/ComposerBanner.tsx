// Adapted from pingdotgg/t3code apps/web/src/components/chat/ComposerBanner.tsx at 57a66608 (MIT).
// Differs from upstream: the class strings scoped to upstream's own named theme are dropped; ours has no such theme id.
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:bg-[color-mix(in_srgb,var(--chat-composer-attached-surface)_var(--glass-opacity),transparent)] before:bg-[linear-gradient(var(--chat-composer-attached-tint),var(--chat-composer-attached-tint))] before:glass-backdrop",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "bg-[color-mix(in_srgb,var(--chat-composer-attached-surface)_var(--glass-opacity),transparent)] glass-backdrop",
