// Adapted from pingdotgg/t3code apps/web/src/components/ui/menu.tsx at 57a66608 (MIT).
"use client";
  ...
  return (
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          className={cn(
            "dropdown-glass popover-shadow relative flex origin-(--transform-origin) rounded-lg outline-none focus:outline-none",
      ...
      {variant === "switch" ? (
        <>
          ...
          <MenuPrimitive.CheckboxItemIndicator
            className="inset-shadow-[0_1px_--theme(--color-black/4%)] inline-flex h-[calc(var(--thumb-size)+2px)] w-[calc(var(--thumb-size)*2-2px)] shrink-0 items-center rounded-full p-px outline-none transition-[background-color,box-shadow] duration-200 [--thumb-size:--spacing(4)] focus-visible:ring-2 focus-visible:ring-ring data-checked:bg-primary data-unchecked:bg-input data-disabled:opacity-64 sm:[--thumb-size:--spacing(3)]"
            keepMounted
          >
