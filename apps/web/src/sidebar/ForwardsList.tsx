...
import { SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuAction, SidebarMenuButton, SidebarMenuItem } from "../components/ui/sidebar.js";
...
export function ForwardsList() {
  ...
  return (
    <SidebarGroup data-testid="forwards-list">
      <SidebarGroupLabel>Forwarded ports</SidebarGroupLabel>
      <SidebarGroupContent>
        <SidebarMenu>
          {forwards.map(f => {
            return (
