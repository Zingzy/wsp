...
// row's state word and second line, a thread row's time and second line),
// the two-line row's height, and the leading slot the workspace dot and the
// thread glyph sit in so a title starts where a name starts.
