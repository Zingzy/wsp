...
// Differs from upstream: cases for the removed brand table and the helpers that moved to the adapter are dropped; the compact-label cases moved here from the timeline logic test.
