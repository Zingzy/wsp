...
// mode a pick moves to, so the palette row and the menu row can never say two
// things about it. A workspace itself is made of a project, which the new
// workspace dialog picks, and no row here makes one.
