...
import { HERE_PLACE_ID, hereWord } from "@wsp/protocol";
import { APP_PLATFORM } from "../settings/places.js";

export const HERE_KEY = `place:${HERE_PLACE_ID}`;

/** Where this computer's shells run, as the drawer's header says it. */
export const HERE_WHERE = `${hereWord(APP_PLATFORM === "darwin")}, ~`;
