...
// One bar per workspace with a sign-in page waiting. The bar names the URL's
// host so the click is never blind; the full URL (it carries the flow's state)
// shows on hover only. Open goes through window.open, which the desktop shell
// hands to the default browser.
...
export function SignInBanner() {
  const pages = useSignInStore(s => s.byWorkspaceId);
