...
import { FREE_WORD, JOINED_COMPUTER, absentComputer, chargesNothing, awayMsOf, daemonSilent, fmtBytes, fmtRate, hereWord, isLocalWorkspace, namesPlace, ownDaemonDown, plural, thisComputer, workspacePlaceId, type AbsentComputer, type CpuWord, type PlaceKind, type PlaceView, type SealedImageCopy, type WorkspaceStatus, type WorkspaceView } from "@wsp/protocol";
