...
export function accountCards(ctx: SettingsContext): SettingsCardData[] {
  ...
  const word = account === null ? undefined : signedIn ? (account.login ?? ACCOUNT_WORDS.signedIn) : ACCOUNT_WORDS.notSignedIn;
  return [
    {
      id: "account",
      items: [
        {
          ...
          ...(word === undefined ? {} : { word, wordClass: "fact" as const, wordK: "account-state" }),
          attrs: { "data-k": "account-row" },
          control: (
