...
// models. One module per harness; a harness without one gets an empty seed
// and its initials. The runtime's catalog answers everything else.
import type { ProviderSlashCommand } from "./view-model.js";

/** One SVG path on a fixed viewBox, filled with the current colour. */
...
export const HARNESS_CLIENTS: ReadonlyArray<HarnessClient> = [CLAUDE_CLIENT];
