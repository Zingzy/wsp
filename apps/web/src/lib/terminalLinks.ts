// Adapted from pingdotgg/t3code apps/web/src/terminal-links.ts at 57a66608 (MIT).
// Differs from upstream: isMacPlatform is defined here; upstream imported it from lib/utils, which ours does not carry.
