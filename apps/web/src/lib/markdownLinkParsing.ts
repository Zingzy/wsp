// Adapted from pingdotgg/t3code packages/client-runtime/src/markdownLinks.ts at 57a66608 (MIT).
// Differs from upstream: one comment example reads NOTE:12 instead of TODO:12 so the repo stays free of that marker.
...
// `Name:digits` also matches `error:1`, `port:3000`, and `NOTE:12`.
