...
/// The close reasons the link puts on a socket it ends.
...
pub fn port_scope_refusal(port: u16) -> String {
...
pub fn listening_line(host: &str, port: u16) -> String {
...
pub fn link_no_answer_in(url: &str, seconds: u64) -> String {
...
pub fn link_quiet(url: &str, seconds: u64) -> String {
