...
3. Run the gates yourself: `pnpm test` and `tsc --noEmit` in a clean worktree of the branch (worktree under ~/wsp/.claude/worktrees/review-<n>, removed when done). A red gate is an automatic blocker finding, not a reason to stop reviewing.
