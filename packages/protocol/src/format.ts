...
import type { GoldenMissingTool, HarnessCatalog, MachineSizeOffer, MachineState, PermissionOutcome, ProjectExportEvent, ProjectImportEvent, ProjectSecret, TerminalConfig, TerminalRgb, TitleSource, ToolPin, TurnResult, WorkspaceSize } from "./index.js";
