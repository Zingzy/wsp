...
const PORT_NAMES = ["AdapterEvent", "ExecStream", "ExecStreamFactory", "HarnessCatalogAnswer", "HarnessCatalogModelProbe", "HarnessCatalogProbe", "HarnessCatalogRefusal", "catalogRefused"];
