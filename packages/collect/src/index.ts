...
export { HAND_DIRS, HAND_GROUP, HAND_PREFIX, brought, carries, formatOf, handBins, handRow, portableShebang, type BinFormat, type HandBin } from "./detect/hand-bins.js";
