...
export { FLAGS, Flag, KINDS, Kind, MEASURED, Measured, Row, Rows } from "./everything/row.js";
...
export { RC_PATHS, type RcScan, type ShellRcOptions, isSecretName, shellRc, stripExports } from "./everything/shell-rc.js";
