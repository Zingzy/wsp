...
import { place, programs } from "./location.js";
...
export async function everything(m: Machine, opts: EverythingOptions = {}): Promise<Everything> {
  ...
  // An empty directory named for a binary folds to that binary's row; when the binary already has one, it folds to nothing.
