...
function stubBackend(rows: Row[] | (() => Row[])) {
  ...
  const backend: MachineBackend = {
    capabilities: { liveCloneForks: true, pauseMode: "memory", replacesMachine: true, previewUrls: true, signedUrls: true, callbackRelay: true, diskSnapshots: true, snapshotsAnyLife: false, snapshotListing: false, templates: false, kept: false, sizes: [] },
