...
function stubBackend(rows: Row[] | (() => Row[])) {
  ...
  const backend: MachineBackend = {
    capabilities: { liveCloneForks: true, pauseMode: "memory", resize: true, previewUrls: true, signedUrls: true, containers: true, callbackRelay: true, snapshotListing: false, templates: false, kept: false, sizes: [] },
