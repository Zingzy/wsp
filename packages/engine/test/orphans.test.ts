...
function stubBackend(rows: Row[] | (() => Row[])) {
  ...
  const backend: MachineBackend = {
    capabilities: { liveCloneForks: true, ramPreservingPause: true, resize: true, previewUrls: true, signedUrls: true, containers: true, callbackRelay: true, snapshotListing: false, templates: false, sizes: [] },
