...
function recordingBackend(
  ...
  const backend: MachineBackend = {
    capabilities: { liveCloneForks: true, pauseMode: "memory", replacesMachine: true, previewUrls: true, signedUrls: true, callbackRelay: true, diskSnapshots: true, images: true, snapshotsAnyLife: opts.snapshotsAnyLife === true, snapshotListing: false, templates: opts.templates === true, kept: false, sizes: [] },
