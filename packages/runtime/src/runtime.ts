 ...
 * nothing about this computer leaves it; and the port this host listens on, for a kind whose machines know an
 * address of their own to write with. */
...
export function createRuntime(opts: RuntimeOptions): Runtime {
  ...
  const modules: Record<WorkspaceKind, KindModule | undefined> = {
    cloud: {
      ...
      // nothing from inside it. Every other fork is somewhere else and dials the address the host advertises.
      hostUrl: entry => {
