...
import { machineLacking, sshDaemonPaths } from "@wsp/protocol";
      ...
      ...(deployed === undefined
        ...
        : {
            deployDaemon: async (machine, login) => {
              ...
              if (deployed.refuse !== undefined) throw deployed.lacks === true ? machineLacking(deployed.refuse) : new Error(deployed.refuse);
