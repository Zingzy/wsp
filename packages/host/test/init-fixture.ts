...
export const FIXTURE: Manifest = {
  entries: [
    ...
    { rung: "logins", id: "logins/gh", label: "GitHub CLI login", paths: ["~/.config/gh/hosts.yml"], bytes: 200, default: "bring" },
    { rung: "logins", id: "logins/claude", label: "Claude Code login", paths: ["Keychain: Claude Code-credentials"], bytes: 0, default: "skip" },
  ],
};
