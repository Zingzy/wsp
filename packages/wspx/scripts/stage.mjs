...
import { ASSETS_DIR, ASSET_KINDS, stageAsset, workspaceAsset } from "@wsp/host";

export function stageAssets(paths) {
  ...
  for (const kind of ASSET_KINDS) stageAsset(paths.from[kind], paths.pkg, kind);
