...
import { CLAUDE_CODE, CLAUDE_CONFIG_DIR, DOCKER_INSTALL, FD_INSTALL, GOLDEN_SETUP, HERMES, HERMES_INSTALL, LOCAL_BIN, MIB, NODE_RELEASES, OP_INSTALL, PLAYWRIGHT, PLAYWRIGHT_INSTALL, PYTHON_INSTALL, RUSTUP_INSTALL, SWIFT, SWIFT_INSTALL, UV_INSTALL, YARN_INSTALL, nodeInstallScript, type InstallRoad } from "./roads.js";
...
export const CATALOG: readonly CatalogEntry[] = [
  // --- agents: the six whose project state a move can follow -------------------------------------------------------
  {
    ...
    installRoad: { road: "script", script: GOLDEN_SETUP, version: CLAUDE_CODE.version, bins: [LOCAL_BIN] },
