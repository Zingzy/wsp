...
// that asks it about that server alone and how its words read. A server
...
export interface McpCheck {
  ...
  measured: string;
  /** The line that asks the harness about one server, which connects to that server alone. */
